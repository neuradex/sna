...
description: Request/response op, 푸시 채널, 재연결 의미론을 설명합니다.
icon: Cable
---

WebSocket이 라이브 채널입니다. 푸시 이벤트(assistant delta, 툴 호출,

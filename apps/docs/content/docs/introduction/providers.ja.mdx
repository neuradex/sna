---
title: プロバイダ
description: AgentProvider インタフェース、runtime pool、プロバイダごとの差分を整理します。
icon: Boxes
---
...
ディスパッチフックです。各プロバイダがどのフィールドをインプレースで
...
2 番目の ACP-speaking プロバイダとして Cursor が加わったことで、

...
| `model` | `claude-sonnet-4-6` | Default model passed to provider adapters when a call does not specify one. |
| `defaultProvider` | `claude-code` | Provider used by routes and helpers unless overridden. |

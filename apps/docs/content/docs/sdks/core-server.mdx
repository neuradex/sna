...
| Runtime session | The runtime process or runtime handle currently attached to a session. A session can have a runtime chain when config changes require respawn. |

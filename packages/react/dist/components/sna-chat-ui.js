...
function FloatingChatButton({ onClick }) {
  return /* @__PURE__ */ jsx(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsx("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", width: 20, height: 20, children: /* @__PURE__ */ jsx("polygon", { points: "332,56 192,272 284,272 178,460 340,232 248,232", fill: "white", stroke: "white", strokeWidth: "8", strokeLinejoin: "round" }) })
    }
  );
}
function SnaChatUI({
  ...
  return /* @__PURE__ */ jsxs(TooltipPrimitive.Provider, { delayDuration: 200, children: [
